...
try:
    ...
    AWS_ACCESS_KEY_ID = os.environ.get("AWS_ACCESS_KEY_ID", "AKIAULJI3YBHQXN455FC")
    AWS_SECRET_ACCESS_KEY = os.environ.get("AWS_SECRET_ACCESS_KEY", "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")

AWS_GROUP_NAME = "CFE_ecommerce_group"
AWS_USERNAME = "digidude"
...
AWS_STORAGE_BUCKET_NAME = 'cfe-ecommerce-pon'
